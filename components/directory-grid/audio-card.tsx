...
export default function AudioCard() {
  ...
  return (
    <Card
      isBlurred
      className="bg-primary-400/20 dark:bg-default-100/50 px-2 border-none max-w-[610px]"
      shadow="sm">
        ...
        <div className="flex flex-col">
          <div className="flex justify-between items-start">
            <div className="flex flex-col gap-0">
              ...
              <p className="text-foreground/80 text-small">12 Tracks</p>
          ...
          <div className="flex flex-col gap-1 mt-3">
            ...
            <div className="flex justify-between">
              ...
              <p className="text-foreground/50 text-small">4:32</p>
            </div>
          </div>
          ...
          <div className="flex justify-center items-center w-full">
            ...
            <Button
              isIconOnly
              className="data-hover:bg-foreground/10! w-auto h-auto"
              radius="full"
              variant="light">
